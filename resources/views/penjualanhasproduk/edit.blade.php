...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Edit penjualan Has Produk</h1>
</div>
    ...
    <div class="col-lg-8">
        ...
        <form method="post" action="/dashboard/penjualan_has_produk/{{ $penjualanhasproduk->id }}" class="mb-3">
            @method('put')
            @csrf
            <div class="mb-3">
            ...
            <select name="penjual_id" id="penjual_id" class="form-select mb-5">
                @foreach ($penjualan as $item)
                   <option value="{{ $item->id }}">{{ $item->tgl }} </option>
                @endforeach
            </select>
            ...
            <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary">Update Penjualan has Produk</button>
        </form>
